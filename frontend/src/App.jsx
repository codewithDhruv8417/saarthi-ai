      ...
      <main>
        ...
        <section className="mx-auto grid max-w-7xl items-center gap-12 px-6 pb-20 pt-16 lg:grid-cols-2 lg:px-16 lg:pt-24">
          ...
          <div className="relative">
            ...
            {/* Decorative Elements */}
            <div className="absolute -bottom-5 -left-5 -z-10 h-32 w-32 rounded-full bg-blue-100 blur-2xl" />

            <div className="absolute -right-5 -top-5 -z-10 h-32 w-32 rounded-full bg-indigo-100 blur-2xl" />
